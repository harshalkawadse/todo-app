    ...
    return (
        <div>
            <div className='container'>
                <div className='box w-40 bg-info  mx-auto my-5 shadow px-4 rounded border border-dark'>
                    ...
                    <div className='input-container d-flex justify-content-between align-items-center px-1 m-2'>
                        <input type='text' 
                            ...
                            className='py-2 px-3 rounded border border-dark fs-5 w-100'
                            value={newTask}
                            onChange={(e)=>{
                                setNewTask(e.target.value)
                            }}/>

                        <select className='p-1 rounded border border-dark w-30 ms-2'
                                value={category}
                                onChange={(e)=>{
